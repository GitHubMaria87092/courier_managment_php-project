...
$sql="insert into products (name,descrip,image,catid,price,qty)values('$name','$desc','$path','$cat','$price','$qty')";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Select Image</label>
                                                <input id="cc-name" name="file" type="file" class="form-control">
...
?>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-name" name="price" type="number"class="form-control" >
                                                
                                               
                                            </div> <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Qty</label>
                                                <input id="cc-name" name="qty" type="number" min=0 max=100 class="form-control">
